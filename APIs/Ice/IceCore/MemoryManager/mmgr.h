...
ICECORE_API void		m_setOwner(const char *file, const unsigned int line, const char *func);
...
ICECORE_API void	*operator new[](size_t reportedSize);
ICECORE_API void	*operator new(size_t reportedSize, const char *sourceFile, int sourceLine);
ICECORE_API void	*operator new[](size_t reportedSize, const char *sourceFile, int sourceLine);
void	operator delete(void *reportedAddress);
ICECORE_API void	operator delete[](void *reportedAddress);
